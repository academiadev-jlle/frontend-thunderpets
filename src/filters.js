...
Vue.filter('genderIcon', (value) => {
  if (value === 'FEMEA') return 'mdi-gender-female';
  else if (value === 'MACHO') return 'mdi-gender-male';
...
Vue.filter('sizeIcon', (value) => {
  if (value === 'PEQUENO') return 'mdi-alpha-p';
  else if (value === 'MEDIO') return 'mdi-alpha-m';
